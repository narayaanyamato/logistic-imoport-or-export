...
$serial = ($page-1) * $limit; 
    ...
    $resultt = mysqli_query($con,"SELECT * FROM about ORDER BY id DESC LIMIT $serial, $limit");
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align:right;">
            <a class="btn btn-primary" href="add-about.php">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
			...
			?> 
				  <tr>
					<td><img style="width:80px;" src="images/about/<?php echo $roww["img"]; ?>"></td>
