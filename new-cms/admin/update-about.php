...
$url = $_POST['url'];
   ...
   if(move_uploaded_file($_FILES["lis_img"]["tmp_name"],"images/about/$fname"))
   echo "file is moved";
   else
...
$insertdata = mysqli_query($con,"INSERT INTO about(title,descrip,img,date,status)VALUES('$title','$descrip','$fname','$today','0')");
...
$insertdata = mysqli_query($con,"UPDATE about SET title='$title',short='$short',descrip='$descrip',img='$fname',date='$today' where id=".$edit."");
