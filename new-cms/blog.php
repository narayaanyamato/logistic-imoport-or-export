...
<div class="section no-pad-bot" id="index-blog">
    <div class="container">
      <br><br>
      <h1 class="header center orange-text">News About Company</h1>
  			  ...
  			  <div class="row">
                   ...
                   if(mysqli_num_rows($res)>0)
                   {
                      ...
                      <div class="col s12 m6 l6">
                   	 	<div class="card #2196f3 blue darken-1 blog-card" style="height: 600px">
		                          ...
		                          <p>Type :<?php echo $row['category']; ?> </p>
								             <p>Dt : <?php echo $row['date']; echo "<br>";?> By Admin</p>
			           ...
			           $res=mysqli_query($con,$sql);
			            if(mysqli_num_rows($res)>0)
			            {
			                while($row=mysqli_fetch_assoc($res))
			                {
			                  ...
			                  ?>
			                  <a href="blog-cato.php?id=<?php echo $row['id']; ?>" class="collection-item"><?php echo $row['title'] ?></a>
			                  <?php
